...
CREATE POLICY "Managers can insert templates" ON envelope_label_templates
  FOR INSERT WITH CHECK (
    auth.jwt() ->> 'role' IN ('manager', 'superadmin')
  );

CREATE POLICY "Managers can update templates" ON envelope_label_templates
  FOR UPDATE USING (
    auth.jwt() ->> 'role' IN ('manager', 'superadmin')
  ) WITH CHECK (
    auth.jwt() ->> 'role' IN ('manager', 'superadmin')
...
CREATE POLICY "Managers can delete templates" ON envelope_label_templates
  FOR DELETE USING (
    auth.jwt() ->> 'role' IN ('manager', 'superadmin')
  );
...
CREATE INDEX IF NOT EXISTS idx_workflow_steps_auth_id ON authorization_workflow_steps(authorization_id);
CREATE INDEX IF NOT EXISTS idx_workflow_steps_status ON authorization_workflow_steps(status);
CREATE INDEX IF NOT EXISTS idx_workflow_steps_assigned ON authorization_workflow_steps(assigned_to);
CREATE INDEX IF NOT EXISTS idx_auth_comm_auth_id ON authorization_communications(authorization_id);
CREATE INDEX IF NOT EXISTS idx_auth_comm_type ON authorization_communications(communication_type);
CREATE INDEX IF NOT EXISTS idx_auth_comm_direction ON authorization_communications(direction);
CREATE INDEX IF NOT EXISTS idx_analytics_date ON authorization_analytics(date);
CREATE INDEX IF NOT EXISTS idx_analytics_provider ON authorization_analytics(provider_id);
CREATE INDEX IF NOT EXISTS idx_analytics_insurance ON authorization_analytics(insurance_provider_id);
CREATE INDEX IF NOT EXISTS idx_audit_logs_auth_id ON authorization_audit_logs(authorization_id);
CREATE INDEX IF NOT EXISTS idx_audit_logs_user_id ON authorization_audit_logs(user_id);
CREATE INDEX IF NOT EXISTS idx_audit_logs_action ON authorization_audit_logs(action);
CREATE INDEX IF NOT EXISTS idx_audit_logs_created_at ON authorization_audit_logs(created_at);
CREATE INDEX IF NOT EXISTS idx_audit_logs_phi_access ON authorization_audit_logs(phi_accessed);
