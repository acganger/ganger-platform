/**
 * Ganger Platform - Inventory Static Worker (R2 Version)
 * Serves the Medical Inventory Management System from R2 object storage
 */
    ...
    try {
      ...
      if (pathname === '/health') {
        return new Response(JSON.stringify({
          ...
          features: ['inventory_management', 'r2_storage', 'nextjs_routing', 'barcode_scanning']
        }), {
      ...
      if (object === null) {
        ...
        if (indexObject === null) {
          return new Response(`Inventory - File not found: ${key}`, { 
            status: 404,
      ...
      return new Response(`Inventory - Error: ${error.message}`, {
        status: 500,
        headers: { 'Content-Type': 'text/plain' }
      });
    }
