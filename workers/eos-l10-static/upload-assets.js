...
/**
 * Upload EOS L10 static assets to R2 bucket
 */
  ...
  try {
    ...
    for (const file of files) {
      try {
        ...
        try {
          const cmd = `npx wrangler r2 object put ganger-eos-l10-assets/${file.key} --file="${tempFile}" --content-type="${contentType}" --remote`;
          execSync(cmd, { 
            stdio: 'pipe',
            env: { 
              ...process.env, 
