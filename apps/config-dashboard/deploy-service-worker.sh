...
echo "🚀 Deploying config-dashboard service worker to staging..."

# Create metadata for service worker
...
echo "📦 Uploading service worker script..."
