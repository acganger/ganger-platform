/**
 * Cloudflare Worker for compliance training Next.js Application
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/compliance/health' || url.pathname === '/health') {
    ...
    try {
      ...
      return new Response(JSON.stringify({
        ...
        message: 'The compliance training application encountered an error',
        timestamp: new Date().toISOString()
      }), {
        status: 500,
        headers: { 'Content-Type': 'application/json' }
