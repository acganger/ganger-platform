/**
 * Cloudflare Worker for Platform Dashboard App
...
async function handleApiRoute(request, env) {
  ...
  if (path === '/api/dashboard') {
    return new Response(JSON.stringify({
      applications: [
        { name: 'Medication Auth', status: 'healthy', url: '/meds' },
        { name: 'Integration Status', status: 'healthy', url: '/status' },
        { name: 'Inventory', status: 'building', url: '/inventory' }
      ],
