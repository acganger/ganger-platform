/**
 * Simple Cloudflare Worker for Call Center Operations
 * Serves static content directly without R2 dependency for quick deployment
 */

// Static HTML content for the Call Center Operations app
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .features h3 { color: #7c3aed; margin-bottom: 1rem; font-size: 1.1rem; }
...
<body>
    <div class="container">
        ...
        <div class="ops-badge">Operations Center</div>
        <h1>Call Center Operations</h1>
        <div class="subtitle">Real-Time Call Management Dashboard</div>
        <p>Comprehensive call center operations dashboard with real-time monitoring, queue management, and performance analytics for Ganger Dermatology call center staff.</p>
        ...
        <div class="features">
            <h3>☎️ Operations Features</h3>
            <ul>
                <li>Real-time call queue monitoring</li>
                <li>Agent performance tracking</li>
                <li>Call routing optimization</li>
                <li>Customer satisfaction metrics</li>
                <li>Wait time analytics</li>
                <li>3CX integration dashboard</li>
            </ul>
        </div>
        
        <p>This is the new Workers-based deployment of the Call Center Operations Dashboard, part of the Ganger Platform modernization.</p>
        ...
        <div class="api-info">
            ...
            <p><strong>Domain:</strong> <code>call-center-ops.gangerdermatology.com</code></p>
            <p><strong>API Health:</strong> <code>/api/health</code></p>
            <p><strong>Queue Status API:</strong> <code>/api/queue/status</code></p>
        </div>
    </div>
...
async function handleApiRoute(request, env, path) {
  ...
  if (path === '/api/health') {
    const healthData = {
      ...
      services: {
        call_system: 'connected',
        queue_manager: 'active',
        analytics_engine: 'ready',
        '3cx_integration': 'enabled'
      }
    };
  ...
  if (path === '/api/agents/performance') {
    return new Response(JSON.stringify({
      total_agents: 0,
      active_agents: 0,
