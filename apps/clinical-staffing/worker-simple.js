/**
 * Simple Cloudflare Worker for Clinical Staffing System
 * Serves static content directly without R2 dependency for quick deployment
 */

// Static HTML content for the Clinical Staffing app
const INDEX_HTML = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Clinical Staffing System - Ganger Dermatology</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .features h3 { color: #db2777; margin-bottom: 1rem; font-size: 1.1rem; }
...
<body>
    <div class="container">
        ...
        <div class="clinical-badge">Healthcare Staffing</div>
        <h1>Clinical Staffing System</h1>
        <div class="subtitle">Medical Staff Scheduling & Management</div>
        <p>Comprehensive clinical staffing management system with real-time scheduling, skill-based assignments, compliance tracking, and workforce optimization for Ganger Dermatology medical staff.</p>
        ...
        <div class="features">
            <h3>👩‍⚕️ Staffing Features</h3>
            <ul>
                <li>Real-time staff scheduling</li>
                <li>Skill-based role assignments</li>
                <li>Compliance certification tracking</li>
                <li>Shift management automation</li>
                <li>Coverage optimization</li>
                <li>Emergency scheduling alerts</li>
            </ul>
        </div>
        
        <p>This is the new Workers-based deployment of the Clinical Staffing System, part of the Ganger Platform modernization.</p>
        ...
        <div class="api-info">
            ...
            <p><strong>Domain:</strong> <code>clinical-staffing.gangerdermatology.com</code></p>
            <p><strong>API Health:</strong> <code>/api/health</code></p>
            <p><strong>Schedule API:</strong> <code>/api/schedule/status</code></p>
        </div>
    </div>
...
async function handleApiRoute(request, env, path) {
  ...
  if (path === '/api/health') {
    const healthData = {
      ...
      services: {
        ...
        staff_database: 'active',
        compliance_tracker: 'ready',
  ...
  // Staff compliance endpoint
  if (path === '/api/staff/compliance') {
    return new Response(JSON.stringify({
      total_staff: 0,
      compliant_staff: 0,
