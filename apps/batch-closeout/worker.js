/**
 * Cloudflare Worker for batch closeout Next.js Application
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/batch/health' || url.pathname === '/health') {
    ...
    try {
      ...
      return new Response(JSON.stringify({
        ...
        message: 'The batch closeout application encountered an error',
        timestamp: new Date().toISOString()
      }), {
        status: 500,
        headers: { 'Content-Type': 'application/json' }
