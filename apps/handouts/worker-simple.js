/**
 * Simple Cloudflare Worker for Patient Handouts Generator
 * Serves static content directly without R2 dependency for quick deployment
 */

// Static HTML content for the patient handouts app
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .features h3 { color: #6366f1; margin-bottom: 1rem; font-size: 1.1rem; }
...
<body>
    <div class="container">
        ...
        <div class="subtitle">Educational Materials Generator</div>
        <p>Custom patient education materials with QR scanning, digital delivery, and integrated communication hub for Ganger Dermatology.</p>
        ...
        <div class="features">
            <h3>🔧 Key Features</h3>
            <ul>
                <li>Custom template library and editor</li>
                <li>QR code generation and scanning</li>
                <li>Digital delivery via SMS and email</li>
        ...
        <p>This is the new Workers-based deployment of the Patient Handouts Generator, part of the Ganger Platform modernization.</p>
        ...
        <div class="api-info">
            ...
            <p><strong>Domain:</strong> <code>handouts.gangerdermatology.com</code></p>
            <p><strong>API Health:</strong> <code>/api/health</code></p>
            <p><strong>Templates API:</strong> <code>/api/templates/status</code></p>
        </div>
    </div>
...
async function handleApiRoute(request, env, path) {
  ...
  // Templates status endpoint
  if (path === '/api/templates/status') {
  ...
  if (path === '/api/qr/generate') {
    return new Response(JSON.stringify({
      qr_service: 'active',
      supported_formats: ['URL', 'Text', 'Contact'],
      max_data_size: '2KB',
