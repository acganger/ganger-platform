/**
 * Cloudflare Worker for integration status Next.js Application
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/status/health' || url.pathname === '/health') {
    ...
    try {
      ...
      return new Response(JSON.stringify({
        ...
        message: 'The integration status application encountered an error',
        timestamp: new Date().toISOString()
      }), {
        status: 500,
        headers: { 'Content-Type': 'application/json' }
