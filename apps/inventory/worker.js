/**
 * Cloudflare Worker for Inventory Management Next.js Application
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (url.pathname === '/inventory/health' || url.pathname === '/health') {
    ...
    try {
      ...
      return new Response(JSON.stringify({
        ...
        message: 'The inventory management application encountered an error',
        timestamp: new Date().toISOString()
      }), {
        status: 500,
        headers: { 'Content-Type': 'application/json' }
