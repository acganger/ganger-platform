...
try {
    ...
    Write-Host ""
    Write-Host "Your Claude Desktop now has 12 MCP servers:" -ForegroundColor White
    Write-Host "  1. Filesystem     7. GCP" -ForegroundColor Gray
    Write-Host "  2. Memory         8. Git" -ForegroundColor Gray  
    Write-Host "  3. Time           9. MySQL Legacy" -ForegroundColor Gray
    Write-Host "  4. Fetch         10. Synology" -ForegroundColor Gray
    Write-Host "  5. Slack         11. Puppeteer " -NoNewline -ForegroundColor Gray
    Write-Host "[NEW]" -ForegroundColor Cyan
    Write-Host "  6. GitHub        12. Trello " -NoNewline -ForegroundColor Gray
    Write-Host "[NEW]" -ForegroundColor Cyan
    Write-Host ""
