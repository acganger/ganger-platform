-- Complete Ganger Platform Database Schema
-- Execute this in Supabase SQL Editor to create ALL application tables
...
CREATE TABLE ai_recommendations (
    ...
    -- INDEX idx_ai_recommendations_type ON ai_recommendations(...) - moved outside table
    -- INDEX idx_ai_recommendations_confidence ON ai_recommendations(...) - moved outside table
);
...
CREATE TABLE authorization_workflow_steps (
    ...
    -- Indexes
    -- INDEX idx_workflow_steps_auth_id ON authorization_workflow_steps(...) - moved outside table
    -- INDEX idx_workflow_steps_status ON authorization_workflow_steps(...) - moved outside table
    -- INDEX idx_workflow_steps_assigned ON authorization_workflow_steps(...) - moved outside table
);
...
CREATE TABLE authorization_communications (
    ...
    -- Indexes
    -- INDEX idx_auth_comm_auth_id ON authorization_communications(...) - moved outside table
    -- INDEX idx_auth_comm_type ON authorization_communications(...) - moved outside table
    -- INDEX idx_auth_comm_direction ON authorization_communications(...) - moved outside table
);
...
CREATE TABLE authorization_analytics (
    ...
    -- Indexes
    -- INDEX idx_analytics_date ON authorization_analytics(...) - moved outside table
    -- INDEX idx_analytics_provider ON authorization_analytics(...) - moved outside table
    -- INDEX idx_analytics_insurance ON authorization_analytics(...) - moved outside table
);
...
CREATE TABLE authorization_audit_logs (
    ...
    -- INDEX idx_audit_logs_auth_id ON authorization_audit_logs(...) - moved outside table
    -- INDEX idx_audit_logs_user_id ON authorization_audit_logs(...) - moved outside table
    -- INDEX idx_audit_logs_action ON authorization_audit_logs(...) - moved outside table
    -- INDEX idx_audit_logs_created_at ON authorization_audit_logs(...) - moved outside table
    -- INDEX idx_audit_logs_phi_access ON authorization_audit_logs(...) - moved outside table
);
...
-- ============================================
-- CREATE INDEX statements (fixed from table definitions)
-- ============================================

CREATE INDEX IF NOT EXISTS INDEX idx_ai_recommendations_type ON ai_recommendations(recommendation_type);
CREATE INDEX IF NOT EXISTS INDEX idx_ai_recommendations_confidence ON ai_recommendations(confidence_score DESC);
CREATE INDEX IF NOT EXISTS INDEX idx_workflow_steps_auth_id ON authorization_workflow_steps(authorization_id);
CREATE INDEX IF NOT EXISTS INDEX idx_workflow_steps_status ON authorization_workflow_steps(status);
CREATE INDEX IF NOT EXISTS INDEX idx_workflow_steps_assigned ON authorization_workflow_steps(assigned_to);
CREATE INDEX IF NOT EXISTS INDEX idx_auth_comm_auth_id ON authorization_communications(authorization_id);
CREATE INDEX IF NOT EXISTS INDEX idx_auth_comm_type ON authorization_communications(communication_type);
CREATE INDEX IF NOT EXISTS INDEX idx_auth_comm_direction ON authorization_communications(direction);
CREATE INDEX IF NOT EXISTS INDEX idx_analytics_date ON authorization_analytics(date);
CREATE INDEX IF NOT EXISTS INDEX idx_analytics_provider ON authorization_analytics(provider_id);
CREATE INDEX IF NOT EXISTS INDEX idx_analytics_insurance ON authorization_analytics(insurance_provider_id);
CREATE INDEX IF NOT EXISTS INDEX idx_audit_logs_auth_id ON authorization_audit_logs(authorization_id);
CREATE INDEX IF NOT EXISTS INDEX idx_audit_logs_user_id ON authorization_audit_logs(user_id);
CREATE INDEX IF NOT EXISTS INDEX idx_audit_logs_action ON authorization_audit_logs(action);
CREATE INDEX IF NOT EXISTS INDEX idx_audit_logs_created_at ON authorization_audit_logs(created_at);
CREATE INDEX IF NOT EXISTS INDEX idx_audit_logs_phi_access ON authorization_audit_logs(phi_accessed);
