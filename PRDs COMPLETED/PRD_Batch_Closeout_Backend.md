...
- **PRD ID**: PRD-BATCH-CLOSEOUT-001 (Backend)
- **Priority**: High
...
- **MCP Integration Requirements**: PDF processing (server-side), File storage (Supabase), Google Sheets MCP
...
// ✅ Standard batch processing constants
const BATCH_STATUS = [
  'uploaded',
  'processing', 
  'parsed',
...
```typescript
// ✅ REQUIRED: Add Batch Closeout to staff portal navigation
...
const STAFF_APPS = [
  // ... existing apps
  {
    ...
    category: 'Business',
    description: 'Daily batch processing, verification, and label generation',
    roles: ['staff', 'manager', 'superadmin', 'billing'],
