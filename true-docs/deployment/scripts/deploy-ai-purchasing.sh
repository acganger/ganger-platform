...
# Deploy AI Purchasing Agent to Vercel
# This script sets up the Vercel project and configures environment variables

set -e

echo "🚀 Deploying AI Purchasing Agent to Vercel..."
...
PROJECT_NAME="ai-purchasing-agent"
APP_PATH="apps/ai-purchasing-agent"
...
curl -X POST "https://api.vercel.com/v10/projects/$PROJECT_NAME/domains" \
  ...
  -H "Content-Type: application/json" \
  -d "{
    \"name\": \"ai-purchasing.gangerdermatology.com\",
    \"teamId\": \"$VERCEL_TEAM_ID\"
  }"
...
echo ""
echo "✅ AI Purchasing Agent deployment initiated!"
echo ""
echo "📝 Next steps:"
...
echo "   - https://ai-purchasing.gangerdermatology.com (after DNS propagation)"
echo ""
echo "3. For staff portal integration, update the Edge Config with:"
echo "   'ai-purchasing': 'https://$PROJECT_NAME.vercel.app'"