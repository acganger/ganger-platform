...
const Toast = ({ id, type = 'info', title, message, duration = 5000, onClose, }) => {
    ...
    return (_jsx("div", { className: cn('pointer-events-auto w-full max-w-sm overflow-hidden rounded-lg border shadow-lg transition-all', typeStyles[type]), children: _jsx("div", { className: "p-4", children: _jsxs("div", { className: "flex items-start", children: [_jsx("div", { className: cn('flex-shrink-0', iconStyles[type]), children: icons[type] }), _jsxs("div", { className: "ml-3 w-0 flex-1", children: [title && (_jsx("p", { className: "text-sm font-medium", children: title })), _jsx("p", { className: cn('text-sm', title ? 'mt-1' : ''), children: message })] }), _jsx("div", { className: "ml-4 flex flex-shrink-0", children: _jsx("button", { className: "inline-flex rounded-md p-1.5 min-h-[44px] min-w-[44px] items-center justify-center focus:outline-none focus:ring-2 focus:ring-offset-2 hover:bg-black/5", onClick: () => onClose(id), "aria-label": "Close notification", children: _jsx("svg", { className: "h-5 w-5", viewBox: "0 0 20 20", fill: "currentColor", "aria-hidden": "true", children: _jsx("path", { fillRule: "evenodd", d: "M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z", clipRule: "evenodd" }) }) }) })] }) }) }));
};
const ToastContainer = ({ toasts }) => (_jsx("div", { className: "fixed top-4 right-4 z-50 space-y-2", role: "region", "aria-label": "Notifications", "aria-live": "polite", children: toasts.map((toast) => (_jsx(Toast, { ...toast }, toast.id))) }));
const ToastProvider = ({ children }) => {
    ...
    return (_jsxs(ToastContext.Provider, { value: contextValue, children: [children, _jsx(ToastContainer, { toasts: toasts })] }));
};
