...
export type ProductCategory = 'gloves_ppe' | 'wound_care' | 'syringes' | 'paper_products' | 'antiseptics' | 'diagnostic_supplies' | 'surgical_supplies' | 'medications' | 'other';
...
export type RequestType = 'consolidated_order' | 'shopping_cart' | 'manual_entry' | 'recurring_order';
export type RequestStatus = 'draft' | 'submitted' | 'analyzing' | 'pending_approval' | 'approved' | 'rejected' | 'ordering' | 'ordered' | 'partially_received' | 'received' | 'cancelled';
...
export type ConsolidatedOrderStatus = 'draft' | 'submitted' | 'analyzing' | 'optimized' | 'approved' | 'ordered';
...
export type VendorOrderSplitStatus = 'pending' | 'placed' | 'confirmed' | 'shipped' | 'delivered' | 'cancelled';
