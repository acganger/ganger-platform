    ...
    async function initializeAuth() {
        try {
            ...
            if (session?.user) {
                ...
                const cookieAccessToken = (0, cookies_1.getCookie)('sb-pfqtzmxxxhhsxmlddrta-auth-token.0');
                const cookieRefreshToken = (0, cookies_1.getCookie)('sb-pfqtzmxxxhhsxmlddrta-auth-token.1');
