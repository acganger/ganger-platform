 ...
 * });
 */
export async function performHealthCheck(serviceName, externalServices = {}) {
 ...
 * });
 */
export function createHealthCheckEndpoint(serviceName, externalServices = {}) {
 ...
 */
function generateRecommendations(connectionMetrics, dbStats) {
