 ...
 */
export declare const encrypt: (text: string, secretKey: string) => string;
/**
 ...
 */
export declare const uniqueBy: <T>(array: T[], key: keyof T | ((item: T) => any)) => T[];
/**
 ...
 */
export declare const throttle: <T extends (...args: any[]) => any>(func: T, wait: number) => T;
/**
 ...
 * );
 */
export declare const promiseAll: <T>(promises: Promise<T>[], concurrency?: number) => Promise<T[]>;
/**
 ...
 * // {page: '2', limit: '10'}
 */
export declare const parseQueryParams: (search: string) => Record<string, string>;
/**
