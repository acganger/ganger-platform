...
export declare function cachedQuery<T>(queryFn: () => Promise<T>, _cacheKey: string, options?: {
    ttl?: number;
    queryName?: string;
    skipCache?: boolean;
}): Promise<T>;
...
export declare function updateInventoryWithCacheInvalidation(itemId: string, updates: any, _locationId?: string): Promise<any>;
